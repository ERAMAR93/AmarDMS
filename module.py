...
def EyeTracking(image, gray, eyePoints,Counter_Focus):
    ...
    pos, color,Counter_Focus = Position([rightBlackPx, centerBlackPx, leftBlackPx],Counter_Focus)
    # print(pos)
	
    return mask, pos, color,Counter_Focus


def Position(ValuesList,Counter_Focus):
		...
		elif Counter_Focus >= 2:
			mq.on_send(posEye)
			
		return posEye, color,Counter_Focus
