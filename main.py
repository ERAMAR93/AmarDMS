...
while True:
    ...
    if face is not None:
        ...
        mask, pos, color,Counter_Focus = m.EyeTracking(frame, grayFrame, RightEyePoint,Counter_Focus)
        maskleft, leftPos, leftColor,Counter_Focus = m.EyeTracking(
            frame, grayFrame, LeftEyePoint,Counter_Focus)
